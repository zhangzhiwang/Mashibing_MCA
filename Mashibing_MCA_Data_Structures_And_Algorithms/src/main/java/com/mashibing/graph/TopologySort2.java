 ...
 * 将题目的表达方式转换成自己熟悉的表达方式然后再开始做题，如果对图玩儿的特别溜就可以职级那题目给的方式来直接做题。
 ...
 * 从Y出发走完后续所有节点所经历的节点个数为num2，如果num1>=num2，就可以认为在最终的拓扑序中X一定排在Y的前面，即X的拓扑序小于等于Y的拓扑序。
...
public class TopologySort2 {
    ...
    static class Record {
        ...
        public Record(DirectedGraphNode node, int nodeCount) {
            this.node = node;

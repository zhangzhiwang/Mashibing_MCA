 ...
 */
public class PrintAllSubsequences2_0830 {
    ...
    private static void recurse(char[] str, int i, String subStr, Set<String> set) {
        if(i == str.length) {
        ...
        recurse(str, i + 1, subStr + str[i], set);
        recurse(str, i + 1, subStr, set);
    }

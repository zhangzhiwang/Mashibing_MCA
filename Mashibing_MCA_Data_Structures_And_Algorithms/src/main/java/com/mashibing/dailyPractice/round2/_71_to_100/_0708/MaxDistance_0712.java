 ...
 */
public class MaxDistance_0712 {
    static class MaxDistanceInfo_0712 {
        private int height;
        private int maxDis;

        public MaxDistanceInfo_0712(int height, int maxDis) {
            this.height = height;
            this.maxDis = maxDis;
        }
    }
    ...
    private static MaxDistanceInfo_0712 recurse(TreeNode x) {
        if(x == null) {
            return new MaxDistanceInfo_0712(0, 0);
        }

        MaxDistanceInfo_0712 left = recurse(x.left);
        MaxDistanceInfo_0712 right = recurse(x.right);
        ...
        return new MaxDistanceInfo_0712(height, maxDis);
    }

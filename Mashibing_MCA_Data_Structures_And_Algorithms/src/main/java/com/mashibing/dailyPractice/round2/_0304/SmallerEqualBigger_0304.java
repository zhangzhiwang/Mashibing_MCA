 ...
 */
public class SmallerEqualBigger_0304 {
    ...
    public static void main(String[] args) {
        SingleNode<Integer> n1 = new SingleNode<>(30);
        SingleNode<Integer> n2 = new SingleNode<>(20);
        SingleNode<Integer> n3 = new SingleNode<>(30);
        SingleNode<Integer> n4 = new SingleNode<>(40);
        SingleNode<Integer> n5 = new SingleNode<>(50);
        SingleNode<Integer> n6 = new SingleNode<>(60);
        SingleNode<Integer> n7 = new SingleNode<>(70);
        SingleNode<Integer> n8 = new SingleNode<>(30);
        n1.next = n2;
        n2.next = n3;
        n3.next = n4;
        n4.next = n5;

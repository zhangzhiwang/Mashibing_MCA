 ...
 */
public class Kruskal_1109 {
    static class KruskalUF_1109 {
        ...
        public KruskalUF_1109(Collection<GraphNode<Integer>> nodes) {
    ...
    public static Set<Edge<Integer>> kruskal(Graph<Integer> graph) {
        ...
        KruskalUF_1109 uf = new KruskalUF_1109(graph.nodes.values());

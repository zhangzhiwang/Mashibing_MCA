 ...
 */
public class SmallerEqualBigger_0214 {
    public static SingleNode<Integer> smallerEqualBigger(SingleNode<Integer> head, int target) {
        ...
        if(eH != null) {
            if(mH != null) {// 这个if不写也行，如果mH是null，将eT.next赋值为null也无所谓
                eT.next = mH;
            }
        }
    ...
    public static void main(String[] args) {
        SingleNode<Integer> n1 = new SingleNode<>(9);
        SingleNode<Integer> n2 = new SingleNode<>(2);
        SingleNode<Integer> n3 = new SingleNode<>(1);
        SingleNode<Integer> n4 = new SingleNode<>(7);
        SingleNode<Integer> n5 = new SingleNode<>(0);
        SingleNode<Integer> n6 = new SingleNode<>(8);
        ...
        SingleNode<Integer> head = smallerEqualBigger(n1, 0);

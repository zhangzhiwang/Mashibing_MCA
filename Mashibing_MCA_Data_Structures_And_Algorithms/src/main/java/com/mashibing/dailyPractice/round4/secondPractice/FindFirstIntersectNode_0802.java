 ...
 * 请实现一个函数：如果两个链表相交就返回相交的第一个节点，如果不相交就返回null
 */
public class FindFirstIntersectNode_0802 {
    public static SingleNode<Integer> findFirstIntersectNode(SingleNode<Integer> head1, SingleNode<Integer> head2) {
        ...
        if(loopNode1 == null && loopNode2 == null) {
            return findIntersectNodeWithNoLoop(head1, head2);
        } else if(loopNode1 != null && loopNode2 != null) {
            return findIntersectNodeWithLoop(head1, loopNode1, head2, loopNode2);
        } else {
            return null;
        }
    }
    ...
    private static SingleNode<Integer> findIntersectNodeWithNoLoop(SingleNode<Integer> head1, SingleNode<Integer> head2) {
...
//        head4_n2.next = head3_n3;
        ...
        head4_n5.next = head4_n3;

        DuiShuQiUtil.printSingleList(head4);
        System.out.println("correct ans:" + getIntersectNode(head2, head4));
        System.out.println("my ans:" + findFirstIntersectNode(head2, head4));
        System.out.println("----------");
    }
}
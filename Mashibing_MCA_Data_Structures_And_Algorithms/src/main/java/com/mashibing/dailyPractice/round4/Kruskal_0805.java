...
public class Kruskal_0805 {
    ...
    public Kruskal_0805(Collection<GraphNode<Integer>> nodes) {
    ...
    private boolean isSameSet(GraphNode<Integer> node1, GraphNode<Integer> node2) {
        return findAnc(node1) == findAnc(node2);
    }

    private void union(GraphNode<Integer> node1, GraphNode<Integer> node2) {
    ...
    public static Set<Edge<Integer>> kruskal(Graph<Integer> graph) {
        ...
        Kruskal_0805 uf = new Kruskal_0805(graph.nodes.values());
        while (!heap.isEmpty()) {
